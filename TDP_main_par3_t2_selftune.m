...
% Calculate V,F
%load('V_F_3t.mat');
load('./mid_data/vd19_V_F_t2_par3.mat');
Vtr = Vtr2;
Vts = Vts2;
clear Vtr2 Vts2;
...
load('./mid_data/T2_Initialize_for_Multi_task_par3.mat');
% testing, single task
num_ts = size(Vts,1);
epoch_ts = 10;
clsnum = length(b);
...
save('./mid_data/self_tune_par3_task2_tdp_trts_fea_label.mat','tr_fea','ts_fea','tr_label','ts_label','-v7.3');
end
